...
## The line
- SELF-HOSTED Outpost, user's own infra, user's own Claude subscription/API key: OK.
...
## Naming
- Product name: "Outpost". Anthropic marks only descriptively: "Outpost — for Claude Code".
  Never "Claude Outpost" in public branding.
